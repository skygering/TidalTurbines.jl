...
mkpath("examples/tidal_uniform/out")

# (1) create mesh
tidal = newProject("flat_tidal", "examples/tidal_uniform")
...
save_solution = SaveSolutionCallback(
    dt = 0.5,
    output_directory = "examples/tidal_uniform/out",
...
trixi2vtk("examples/tidal_uniform/out/solution_*.h5",
          output_directory = "examples/tidal_uniform/out/vtk")